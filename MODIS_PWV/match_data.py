...
class Match_Data(object):
    ...
    def read_files(self, modis_file,aeronet_file):
        ...
        self.modis_end.columns = ["Date_MODIS", "Time_MODIS", "PWV_MODIS"]
        ...
        self.aeronet_end.columns=["Time_AERONET", "PWV_AERONET"]
    ...
    def find_closest_date(self, timepoint, time_series):
        ...
        if len(passer[0]) != 0:
            ...
            res={"closest_time":self.aeronet_end["Time_AERONET"].loc[idx_closest_date], "pwv_value": self.aeronet_end["PWV_AERONET"].loc[idx_closest_date]*10.}
            #indices del diccionario para ser introducidos en pd.Series
            idx = ['closest_time', 'pwv_value']
        ...
        #lleno los valosre con NaT(Not a Time) y NaN(Not a Number)
            ...
            res = {"closest_time": "NaN","pwv_value": "NaN"}
            idx = ['closest_time', 'pwv_value']
            return pd.Series(res, index=idx)
    
    def match_aod(self,modis_grid,station_name):
        self.modis_end[['Time_AERONET', 'PWV_AERONET']] = self.modis_data["Date_MODIS Time_MODIS"].apply(self.find_closest_date,args=[self.aeronet_data["Date_AERONET Time_AERONET"]])
...
if __name__ == "__main__":
    ...
    for modis_grid in modis_files:
        ...
        run_match.match_aod(modis_grid[-16:-13],aeronet_file[:-12])
