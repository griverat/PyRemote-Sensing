...
AERONET_station = "Huancayo"
years_range="2002-2017"
x_label = r"AERONET Level 2.0 PWV mm"
y_label = "MODIS AQUA PWV at 10km"
...
file_to_plot = [x for x in os.listdir(os.getcwd()) \
               if x.endswith("{}pwv{}_matched_data.txt".format(\
...
axes.scatter(data['PWV_AERONET'],data['PWV_MODIS'])
